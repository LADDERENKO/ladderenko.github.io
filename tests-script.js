const quizzes = {
    ...
    'realLife': {
        ...
        questions: [
            {
                q: "Какова основная цель игры «Тактильный Контакт»?",
                a: ["Победить по очкам", "Разбавить скучную жизнь контролируемым безумием", "Сделать другу больно", "Найти новых друзей"],
                c: 1
            },
            {
                q: "Что является ключевым действием в игре?",
                a: ["Внезапно схватить друга за пенисок", "Похлопать друга по плечу", "Кричать «BAM I BAAM»", "Ударить его кувалдой"],
                c: 0
            },
            {
                q: "Какова главная «закупка» для этой игры?",
                a: ["Пачка сигарет", "Быстрая и крепкая рука", "Кувалда", "Ничего не нужно покупать"],
                c: 1
            },
            {
                q: "Что, по мнению Профессора, является, так сказать, «самой чувствительной частью тела»?",
                a: ["Рука", "Шея", "Нога", "Хуй"],
                c: 3
            },
            {
                q: "Что должен кричать ваш друг, чтобы вы поняли, что добились успеха?",
                a: ["«ДА КАК ВЫ ЗАЕБАЛИ ДОЛБОЕБЫ»", "«Что это было?»", "«Я тебя сейчас убью!»", "«Отпусти меня!»"],
                c: 0
            }
        ]
    },
